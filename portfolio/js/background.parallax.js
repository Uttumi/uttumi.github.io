...
(function($)
{
	...
	$.ParalaxBackground.prototype._updateElement = function(background)
	{
		...
		const scrollDelta = scrollPosition - this.previousScrollPosition;
		...
		// const nextPosition = position - scrollDelta * speed;
	...
	$.ParalaxBackground.prototype._getScrollPosition = function()
	{
		...
		return window.scrollY || html.scrollTop ||document.body.scrollTop;
	};
